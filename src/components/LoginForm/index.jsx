...
const LoginForm = () => {
    ...
    useEffect(() => {
        const fetchShops = async () => {
            try {
                const response = await axios.get('http://localhost/Garden_v0.0004/php/getShops.php');
    ...
    const handleSignupSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost/Garden_v0.0004/php/signup.php', formData, {
                headers: {
    ...
    const handleLoginSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost/Garden_v0.0004/php/login.php', loginData, {
                headers: {
